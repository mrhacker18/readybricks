                  <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                <th>Transporter Name</th> <th>Name</th><th>Phone No</th><th>License No.</th> <th>Status</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tfoot>
                        ...
                        <tbody>
                            <tr ng-repeat="item in list">
                                ...
                                <td class="text-center">
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Driver&type=New" ng-if="$index % 2 != 0" class="btn btn-outline-info"> <i class="os-icon os-icon-eye" style="margin-top: -3px;"></i></a>
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Driver&type=Edited" ng-if="$index % 2 == 0" class="btn btn-outline-info"> <i class="os-icon os-icon-eye" style="margin-top: -3px;"></i></a>
                                </td>
                            </tr>
