                        ...
                        <tbody>
                            <tr ng-repeat="item in list">
                                ...
                                <td class="text-center">
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Vehicle&type=New" ng-if="$index % 2 != 0" class="btn btn-outline-info" style="margin-top: -8px;"> <i class="os-icon os-icon-eye" ></i></a>
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Vehicle&type=Edited" ng-if="$index % 2 == 0" class="btn btn-outline-info" style="margin-top: -8px;"> <i class="os-icon os-icon-eye" ></i></a>

                                </td>
                            </tr>
                            <tr ng-show="list.length ==0"><td colspan="10" class="text-center">Vehicel Not found</td></tr>
