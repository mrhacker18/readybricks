<script src="static/appScript/CategoryCtrl.js"></script>
...
<!--                 		<td>{{category.catId}}</td>
 -->                		<td>{{category.catName}}</td>
                        <td><lable ng-show="category.catStatus == '1'" class="label label-primary">Active</lable><lable ng-show="category.catStatus == '0'" class="label label-warning">Deactive</lable></td>
                        <td><button type="button" class="btn btn-xs btn-primary" ng-show="category.catStatus == '0'" ng-click="changeItemStatus(category.catId,1)">Active</button>
                        <button type="button" class="btn  btn-xs btn-warning" ng-show="category.catStatus == '1'" ng-click="changeItemStatus(category.catId,0)">Deactive</button>&nbsp;&nbsp;
                        <button type="button" class="btn  btn-xs btn-danger" ng-click="deleteItem(category.catId)">Delete</button> </td>
                	</tr>
                  	<tr ng-show="list.length ==0"><td colspan="3" class="text-center">Category Not found</td></tr>
...
<div class="block">
    ...
    <form action="#"  name="myForm" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
        ...
        <div class="form-group" ng-class="nameError ? 'has-error':''">
            ...
            <div class="col-md-9">
                <input type="text" id="example-text-input" name="name" id="name" ng-model="category.name"  class="form-control" placeholder="Name" ng-focus="hideErrorMsg('nameError')">
