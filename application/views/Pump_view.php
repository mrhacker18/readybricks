<script src="static/appScript/PumpCtrl.js"></script>
<script>function getAuth(){ <?php echo $fx ?>;}</script>
<?php if ($read): ?>
<div ng-controller="PumpCtrl">
    ...
    <div class="block full">
    	<div class="block-title">
           <div class="block-options pull-right">
            <a href="javascript:void(0)" class="btn  btn-sm btn-primary toggle-bordered enable-tooltip" data-toggle="button" title="" data-original-title="Toggles .form-bordered class" aria-pressed="false" ng-show="auth.insert" ng-click="showForm()" >Add Pump</a>
            </div>
            <h2><strong>Manage</strong> Pump</h2>
        </div>
...
<!--                 		<td>{{category.catId}}</td>
 -->                		<td>{{item.Name}}</td>
                        ...
                        &nbsp;&nbsp;
                        <button type="button" class="btn  btn-xs btn-danger" ng-click="deleteItem(item.PumpId)">Delete</button> </td>
                	</tr>
                  	<tr ng-show="list.length ==0"><td colspan="3" class="text-center">Pump Not found</td></tr>
...
<div class="block">
    ...
    <div class="block-title">
        <h2><strong>{{datatype}}</strong> Pump</h2>
    </div>
