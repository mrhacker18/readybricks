                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <tbody>
                            <tr>
                              <td class="nowrap"> #11000 </td>
                              <td > John Mayers </td>
                              <td> 2929 </td>
                              <td >Rs.200 </td>
                              <td class="text-right">
                                <a class="badge badge-danger" href="">Pending</a>
                              </td>
                            </tr>

                            <tr>
                              <td class="nowrap"> #11001 </td>
                              <td > Ravi Gotecha </td>
                              <td> 3000 </td>
                              <td >Rs.240 </td>
                              <td class="text-right">
                            ...
                            <tr>
                              <td class="nowrap"> #11002 </td>
                              <td > Mayur sharviya </td>
                              <td> 4929 </td>
                              <td >Rs.4900 </td>
                              <td class="text-right">
                                <a class="badge badge-danger" href="">Pending</a>
                  ...
                  <div class="element-wrapper">
                    ...
                    <div class="element-box">
                      <div class="el-chart-w"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                        <canvas height="242" id="donutChart" width="242" class="chartjs-render-monitor" style="display: block; width: 242px; height: 242px;"></canvas>
...
<?php /*
                        ...
                        <div class="content-header content-header-media">
                            ...
                            <img src="static/img/placeholders/headers/dashboard_header.jpg" alt="header image" class="animation-pulseSlow">
                        </div>
                                            ...
                                            <ul class="timeline-list">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="static/img/placeholders/photos/photo1.jpg" data-toggle="lightbox-image">
                                                                    <img src="static/img/placeholders/photos/photo1.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="static/img/placeholders/photos/photo22.jpg" data-toggle="lightbox-image">
                                                                    <img src="static/img/placeholders/photos/photo22.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="active">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="static/img/placeholders/photos/photo23.jpg" data-toggle="lightbox-image">
                                                                    <img src="static/img/placeholders/photos/photo23.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="widget">
                                    <div class="widget-advanced widget-advanced-alt">
                                        ...
                                        <div class="widget-header text-left">
                                            ...
                                            <img src="static/img/placeholders/headers/widget5_header.jpg" alt="background" class="widget-background animation-pulseSlow">
                                            ...
                                            <div class="gallery gallery-widget" data-toggle="lightbox-gallery">
                                                <div class="row">
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="static/img/placeholders/photos/photo15.jpg" class="gallery-link" title="Image Info">
                                                            <img src="static/img/placeholders/photos/photo15.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="static/img/placeholders/photos/photo5.jpg" class="gallery-link" title="Image Info">
                                                            <img src="static/img/placeholders/photos/photo5.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="static/img/placeholders/photos/photo6.jpg" class="gallery-link" title="Image Info">
                                                            <img src="static/img/placeholders/photos/photo6.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="static/img/placeholders/photos/photo13.jpg" class="gallery-link" title="Image Info">
                                                            <img src="static/img/placeholders/photos/photo13.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
