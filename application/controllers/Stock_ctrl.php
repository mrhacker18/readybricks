...
class Stock_ctrl extends base_ctrl {
	function __construct() {
		parent::__construct();		
	    $this->load->model('SerialNumber_model','model');
	}
...
//		print_r($this->auth);
	...
	public function get_Model_list(){
		print  json_encode($this->model->get_Model_list());
	}
	...
	{	
		$data=$this->post();
		print json_encode($this->model->get_page($data->size, $data->pageno,$data->customfilter));
	}
