...
//    console.log($scope.totalpaging);
 ...
 PumpCtrl.prototype.init=function($scope){
	$scope.search=null;
	$scope.item=null;
	$scope.list = null;
	$scope.fgShowHide=true;
...
PumpCtrl.prototype.configureGrid=function($scope){
	$scope.totalItems = 0;
    $scope.pagingOptions = {
...
PumpCtrl.prototype.searchPopup=function($scope){
