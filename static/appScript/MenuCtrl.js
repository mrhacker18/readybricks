...
function MenuCtrl($scope, $http){	
	...
	loadData('get_Category_list',{}).success(function(data){$scope.CategoryList=data;});
...
//		angular.extend( params, $scope.search);
 ...
 MenuCtrl.prototype.init=function($scope){
	$scope.search=null;
	$scope.item=null;
	$scope.list = null;
	$scope.itemtitle = "Add";
...
MenuCtrl.prototype.configureGrid=function($scope){
	$scope.totalItems = 0;
    $scope.pagingOptions = {
...
MenuCtrl.prototype.searchPopup=function($scope){
